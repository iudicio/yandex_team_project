...
Готовое описание PR первой итерации находится в [documentation/09-iteration-1-review.md](./documentation/09-iteration-1-review.md). Функции следующего этапа не добавляются в более раннюю review-ветку.
